...
//		Server.startWebServer(conn);  //TODO
	...
	public void testSingleMovieRepositoryAutoCommit() {
		...
		groupList1.add(userGroup2);
		
		List<UserGroup> groupList2 = new ArrayList<UserGroup>();
		groupList2.add(userGroup2);
		
//		System.out.println(userRepository.count();
//		Assert.assertEquals(2, userRepository.findByUserGroupsIn(groupList1).size()); //TODO
//		Assert.assertEquals(1, userRepository.findByUserGroupsIn(groupList2).size());

		
		Assert.assertEquals(2, getGroupWithUsers(userGroup1.getId()).getUsers().size());
		Assert.assertEquals(1, getGroupWithUsers(userGroup2.getId()).getUsers().size());
...
//		List<Comment> comments = movie.getComments();
		...
		List<Comment> comments = commentRepository.findByMovieOrderByCreationDateDesc(movie);
...
/*
	@Transactional
	public void testSingleMovieRepositoryInTransaction() {
